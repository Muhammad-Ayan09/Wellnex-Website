      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center gap-5 xl:gap-6">
            ...
            <button
              onClick={toggleTheme}
              className={`relative w-14 h-8 rounded-full transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-orange-500/40 ${
                theme === "dark"
                  ? "bg-gradient-to-r from-gray-800 to-gray-700 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.06)]"
                  : "bg-gradient-to-r from-white to-gray-100 shadow-[inset_0_0_0_1px_rgba(0,0,0,0.06)]"
              }`}
            ...
            >
              <div
                className={`absolute top-1 left-1 w-6 h-6 rounded-full transition-all duration-300 will-change-transform ${
                  theme === "dark"
                    ? "translate-x-6 bg-orange-500 shadow-lg shadow-orange-500/30"
                    : "bg-white shadow-lg"
                }`}
              />
              <Sun
                className={`absolute left-2 top-1/2 -translate-y-1/2 w-4 h-4 pointer-events-none transition-all duration-300 ${
                  theme === "light" ? "opacity-100 text-yellow-500" : "opacity-50 text-yellow-400/60"
                }`}
              />
              <Moon
                className={`absolute right-2 top-1/2 -translate-y-1/2 w-4 h-4 pointer-events-none transition-all duration-300 ${
                  theme === "dark" ? "opacity-100 text-blue-400" : "opacity-50 text-blue-400/60"
                }`}
              />
            </button>
