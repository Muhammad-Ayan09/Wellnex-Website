        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center gap-5 xl:gap-6">
            ...
            >
              ...
              <Sun
                className={`absolute left-1.5 top-1/2 -translate-y-1/2 w-3.5 h-3.5 pointer-events-none transition-all duration-300 ${
                  theme === "light"
              ...
              />
              <Moon
                className={`absolute right-1.5 top-1/2 -translate-y-1/2 w-3.5 h-3.5 pointer-events-none transition-all duration-300 ${
