                ...
                <div className="mt-4 flex items-center justify-between">
                  ...
                  <div className="ml-4 flex items-center gap-3">
                    <a
                      ...
                      className={`inline-flex items-center justify-center transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-orange-500/60`}
                    >
                      <img src={appstoreImg} alt="App Store" className="h-8 w-auto" />
                    </a>
                    <a
                      href="#"
                      ...
                      className={`inline-flex items-center justify-center transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-orange-500/60`}
                    >
                      <img src={playstoreImg} alt="Google Play" className="h-8 w-auto" />
                    </a>
                  </div>
                </div>
              </div>
